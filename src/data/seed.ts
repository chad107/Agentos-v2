/**
 * Demo dataset. Expands sample-data/agentos-demo-data.json (kept as the
 * canonical narrative seed — see reference/SOURCE_MAP.md) into full typed
 * entities covering every v1 screen, per PROMPT_TO_START_CLAUDE_CODE.md #4
 * ("Seed the app with sample-data/agentos-demo-data.json").
 *
 * Timestamps are generated relative to "now" (src/lib/dates.ts) rather than
 * hard-coded, so the demo always reads as live/current and the safety JSA
 * 4:00/4:30 cadence (CLAUDE.md "Daily cadence") behaves correctly whenever
 * this is run. This module has no side effects beyond building plain data —
 * src/data/store.ts owns the mutable in-memory store.
 */
...
/** Valley River's configured lead-response SLA (tenant setting, not a platform constant). */
...
// Users
// ---------------------------------------------------------------------------
// 12_OPEN_ITEMS.md: exact roster/emails are not supplied — these are the
// named roles/people that appear directly in the spec package (Al, Tanya,
// Aiden Brennan), plus the signed-in demo account. Do not treat as real
...
export const sourceRecords: SourceRecord[] = [
  ...
  { id: "src_qbo_vendor_gree", integration: "qbo", externalId: "vendor_gree", entityType: "vendor", canonicalRef: "qbo:vendor_gree", syncedAt: toISO(daysAgo(1)), sourceUrl: null },
...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    currentTask: null,
    openFindingsCount: 0,
    recentAccuracyNote: "Paused pending business hours, transfer-number and booking-authority configuration (12_OPEN_ITEMS.md)."
  },
  {
    id: "research",
...
export const agentRuns: AgentRun[] = [
  ...
  { id: "run_accounting_1", agentId: "accounting", trigger: "bill_due_monitor", startedAt: toISO(hoursAgo(3.1)), endedAt: toISO(hoursAgo(3)), status: "completed", inputRefs: ["email:msg_991", "qbo:vendor_gree"], outputSummary: "Vendor invoice matched; bill data prepared for review.", error: null },
...
export const findings: Finding[] = [
  {
    ...
    summary: "Job 2048 is scheduled tomorrow at 8:00 AM. The Gree outdoor unit shipment referenced on the estimate has not been confirmed with the supplier.",
  ...
  },
  {
    ...
    summary: "Quote 7781 for the Doucette install replacement was sent and has passed the day-3/4 manual follow-up window with no customer response.",
  ...
  },
  {
    ...
    summary: `A business-day heat-pump install request from Meredith Foster has gone unanswered past the ${SALES_SLA_MINUTES}-minute response target.`,
  ...
  },
  {
    ...
    summary: "A Gree Canada invoice was captured from the authorized email inbox and is due within 3 business days.",
    entityRefs: ["accounting:acct_bill_gree"],
    evidenceRefs: ["email:msg_991", "qbo:vendor_gree"],
    confidence: "high",
...
export const recommendations: Recommendation[] = [
  {
    ...
    decisionRequired: "Approve Tanya to contact the supplier / approve the proposed follow-up.",
  ...
  },
  {
    ...
    summary: `Meredith Foster's install request has gone unanswered past the ${SALES_SLA_MINUTES}-minute business-day response target.`,
...
export const actionProposals: ActionProposal[] = [
  {
    ...
    description: "Draft a follow-up message to Gree Canada / Midland Transport confirming the outdoor-unit shipment for job 2048, and a note asking Tanya to send it.",
    initiatorAgentId: "operations",
    targetRef: "jobber:job_2048",
    payload: {
      channel: "email",
      to: "orders@greecanada.example",
      subject: "Shipment confirmation needed — Job 2048 (install tomorrow)",
      body: "Hi team, can you confirm tracking for the outdoor unit on estimate 2048? Install is scheduled for tomorrow 8:00 AM and we don't yet have a Midland Transport tracking number. Thanks, Valley River Heat Pumps."
    },
  ...
  },
  {
    ...
    description: "Draft a first-response email to Meredith Foster acknowledging her install request and proposing an assessment time.",
    initiatorAgentId: "sales",
    targetRef: "jobber:request_5510",
    payload: {
      channel: "email",
      to: "meredith.foster@example.com",
      subject: "Thanks for reaching out to Valley River Heat Pumps",
      body: "Hi Meredith, thanks for your interest in a ducted heat-pump install. I'd like to set up a quick assessment — does later this week work? — Tanya, Valley River Heat Pumps."
    },
    permissionClass: "draft",
    approverRole: "administrator",
    status: "pending",
  ...
  },
  {
    ...
    description: "Draft a day-3/4 manual follow-up message to Karen & Mike Doucette on the outstanding $18,500 quote.",
    initiatorAgentId: "sales",
    targetRef: "jobber:quote_7781",
    payload: {
      channel: "email",
      to: "doucette@example.com",
      subject: "Checking in on your heat pump quote",
      body: "Hi Karen and Mike, just checking in on the quote we sent over — happy to answer any questions or adjust anything. — Valley River Heat Pumps."
    },
    permissionClass: "draft",
    approverRole: "administrator",
    status: "pending",
  ...
  },
  {
    ...
    description: "Review the prepared QuickBooks Online bill data for the Gree Canada invoice before it is entered.",
    initiatorAgentId: "accounting",
    targetRef: "qbo:vendor_gree",
    payload: {
      vendor: "Gree Canada",
      amount: 4820.0,
      dueAt: toISO(businessDaysFromNow(3)),
  ...
  },
  {
    ...
    description: "Create an internal reminder task for Al to submit closeout photos for last week's Coldbrook install.",
    initiatorAgentId: "operations",
    targetRef: "jobber:job_1990",
    payload: { assignee: "u_al", note: "Please add closeout photos + model numbers to CompanyCam for job 1990." },
    permissionClass: "draft",
...
export const leads: Lead[] = [
  {
    id: "lead_1001",
    source: "jobber",
    customerRef: "customer_foster",
    customerName: "Meredith Foster",
  ...
  },
  {
    ...
    customerRef: "customer_whitman",
    customerName: "Devon Whitman",
    ...
    ownerId: "u_tanya",
    ownerName: "Tanya",
    latestTouch: "Tanya replied to confirm assessment time",
  ...
  },
  {
    id: "lead_1003",
    source: "jobber",
    customerRef: "customer_doucette",
    customerName: "Karen & Mike Doucette",
  ...
  },
  {
    ...
    customerRef: "customer_park",
    customerName: "Path Green",
...
export const jobs: Job[] = [
  ...
  },
  {
    id: "job_1955",
    jobberId: "1955",
    customerRef: "customer_landry",
    customerName: "Marc Landry",
    serviceType: "Ductless mini-split, 2 zones",
    community: "Wolfville",
  ...
  },
  {
    id: "job_1990",
    jobberId: "1990",
    customerRef: "customer_coldbrook",
    customerName: "Coldbrook Residence",
  ...
  },
  {
    id: "job_1888",
    jobberId: "1888",
    customerRef: "customer_berwick",
    customerName: "Berwick Residence",
    serviceType: "Ducted heat pump install",
    community: "Berwick",
...
export const jobRequirements: JobRequirement[] = [
  { id: "req_8801", jobId: "job_2048", type: "equipment", description: "Confirm outdoor unit shipment with Gree Canada / Midland Transport", requiredBy: toISO(todayAt(15, 0)), status: "missing", ownerRef: "u_tanya", evidenceRef: null },
  { id: "req_8802", jobId: "job_2048", type: "jsa", description: "Daily JSA photo for tomorrow's install crew", requiredBy: toISO(businessDaysFromNow(1, todayAt(16, 0))), status: "pending", ownerRef: "u_al", evidenceRef: null },
  { id: "req_8803", jobId: "job_2048", type: "note", description: "Confirm customer is home for 8:00 AM start", requiredBy: toISO(todayAt(17, 0)), status: "pending", ownerRef: "u_tanya", evidenceRef: null },
  { id: "req_1990_1", jobId: "job_1990", type: "photo", description: "Closeout install photos", requiredBy: toISO(daysAgo(4, todayAt(16, 0))), status: "missing", ownerRef: "u_al", evidenceRef: null },
  { id: "req_1990_2", jobId: "job_1990", type: "model_number", description: "Outdoor + indoor unit model numbers", requiredBy: toISO(daysAgo(4, todayAt(16, 0))), status: "missing", ownerRef: "u_al", evidenceRef: null },
  { id: "req_1955_1", jobId: "job_1955", type: "equipment", description: "Confirm mini-split delivery", requiredBy: toISO(businessDaysFromNow(1)), status: "satisfied", ownerRef: "u_tanya", evidenceRef: "jobber:estimate_1955" }
];

export const equipmentItems: EquipmentItem[] = [
  { id: "equip_2048_1", jobId: "job_2048", sourceEstimateLineRef: "estimate_2048:line_1", manufacturer: "Gree", model: "Flexx 24k Outdoor Unit", quantity: 1, status: "unconfirmed", supplier: "Gree Canada", trackingRef: null },
  { id: "equip_2048_2", jobId: "job_2048", sourceEstimateLineRef: "estimate_2048:line_2", manufacturer: "Gree", model: "Flexx 24k Indoor Air Handler", quantity: 1, status: "confirmed", supplier: "Gree Canada", trackingRef: "MID-88213-NS" },
  { id: "equip_1955_1", jobId: "job_1955", sourceEstimateLineRef: "estimate_1955:line_1", manufacturer: "Gree", model: "Multi-18 2-Zone", quantity: 1, status: "delivered", supplier: "Gree Canada", trackingRef: "MID-87990-NS" }
];
...
export const accountingItems: AccountingItem[] = [
  {
    id: "acct_bill_gree",
    type: "vendor_bill",
    vendorOrCustomerRef: "qbo:vendor_gree",
    vendorOrCustomerName: "Gree Canada",
  ...
  },
  {
    ...
    type: "deposit",
    vendorOrCustomerRef: "customer_doucette",
    vendorOrCustomerName: "Karen & Mike Doucette",
  ...
  },
  {
    ...
    vendorOrCustomerRef: "customer_berwick",
    vendorOrCustomerName: "Berwick Residence",
  ...
  {
    id: "acct_statement_wolseley",
    type: "statement",
    vendorOrCustomerRef: "vendor_wolseley",
    vendorOrCustomerName: "Wolseley",
...
export const voiceCalls: VoiceCall[] = [
  {
    ...
    providerCallId: "701",
    direction: "inbound",
    contactRef: "customer_whitman",
    contactName: "Devon Whitman",
...
export const notifications: Notification[] = [
  {
    ...
    body: `Meredith Foster's request has gone unanswered past the ${SALES_SLA_MINUTES}-minute target.`,
    recommendationId: "rec_004",
    channel: "push",
    status: "delivered",
    createdAt: toISO(hoursAgo(0.4)),
